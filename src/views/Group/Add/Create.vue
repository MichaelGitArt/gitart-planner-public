<template>
  <div>
    <v-stepper vertical v-model="stage">
      <v-stepper-step :complete="stage > 1" step="1">Назва групи</v-stepper-step>
      ...
      <v-stepper-step :complete="stage > 2" step="2">Твоя нова група</v-stepper-step>

      <v-stepper-content step="2">
        <v-card v-if="createdGroup" max-width="420" outlined>
          <v-list-item three-line>
            <v-list-item-content>
              <v-list-item-title class="headline mb-1 font-weight-bold">{{createdGroup.name}}</v-list-item-title>
              <p
                class="body-2 font-weight-light"
              >Додавай нових учасників групи на сторінці керування групою</p>
            ...
            <v-icon large color="green" class="px-1 hidden-sm-and-down">mdi-checkbox-marked-circle</v-icon>
          </v-list-item>

          <v-card-actions>
            <v-btn small color="success" disabled>Керувати</v-btn>
          </v-card-actions>
        </v-card>
      </v-stepper-content>
    </v-stepper>
